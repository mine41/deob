...
$null = New-Item -ItemType ('Direct'+'o'+'ry') -Path $artifactDir -Force
$layoutPath = Join-Path $artifactDir "window-layout.json"
[ordered]@{ View = "dashboard"; Sidebar = "open"; Zoom = 125 } | ConvertTo-Json | Set-Content -Path $layoutPath -Encoding ('U'+'TF8')
